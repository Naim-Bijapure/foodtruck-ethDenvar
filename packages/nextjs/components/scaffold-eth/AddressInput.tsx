      ...
      <div className="form-control grow">
        <div className="flex w-full">
          ...
          <input
            ...
            className={`input input-primary input-bordered focus:outline-none focus:bg-transparent focus:text-gray-400 h-[2.2rem] min-h-[2.2rem] border w-full font-medium placeholder:text-accent/50 text-gray-400 grow ${
